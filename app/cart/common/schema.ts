import { TCompanyPost, TTypeDelivery } from '@/app/cart/formOrder.t';
...
const schema = yup
  .object({
    ...
    warehouseRef: yup.string().required('Вибір служби доставки є обов’язковим'),
