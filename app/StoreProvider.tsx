...
import type { AppStore } from '@/lib/store/store'; // Тип для хранилища Redux (будет определяться в файле store.ts)
import { makeStore } from '@/lib/store/store'; // Функция для создания нового хранилища Redux
