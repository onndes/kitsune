...
import { useColorMode } from '../contexts/ColorModeContext' // Импортируем хук для работы с контекстом
  ...
  return (
    <Box
      sx={{
        ...
        borderRadius: 2,
        backgroundColor:
          mode === 'light' ? '#f0f0f0' : '#333333', // Цвет фона зависит от темы
        color: mode === 'light' ? '#000000' : '#ffffff', // Цвет текста зависит от темы
        textAlign: 'center',
      }}
    >
      <Typography variant="h6">
        This element changes with the theme!
      </Typography>
    </Box>
  )
}
